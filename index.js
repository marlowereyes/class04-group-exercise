...
/**
 * initialise the variable apple to the value of 5
 * increment the variable apple by 2
 * decrement the variable apple by 1
 * console log the variable apple. 
 * write a single line comment as to what that output will be
 */
...
/**
 * initialise the variable parnell to the value of 13
 * initialise the variable marlowe to the value of 24
 * initialise the variable max to the value of 11
 * initialise all names to the average of parnell, marlowe, and max (use camel case)
 * console log out the variable all names
 * write a single line comment as to what that output will be
 */
var parnell = 13;
var marlowe = 24;
...
/**
 * initialise the variable deluka to the value of 21
 * initialise the variable pia to the value of 34
 * initialise total to the average of both names 
 * console log out the variable total
 * write a single line comment as to what that output will be
 */
 var deluka = 21;
 var pia = 34;
 var total = (deluka + pia)/2;
